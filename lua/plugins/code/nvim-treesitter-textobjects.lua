return {
  ...
  keys = {
    ...
    {
      'aa',
      function() require('nvim-treesitter-textobjects.select').select_textobject('@parameter.outer') end,
      mode = { 'x', 'o' },
      desc = 'a argument',
    },
    {
      'ia',
      function() require('nvim-treesitter-textobjects.select').select_textobject('@parameter.inner') end,
      mode = { 'x', 'o' },
    ...
    {
      'ar',
      function() require('nvim-treesitter-textobjects.select').select_textobject('@return.outer') end,
      mode = { 'x', 'o' },
      desc = 'a return',
    },
    {
    ...
    {
      ']a',
      function() require('nvim-treesitter-textobjects.move').goto_next_start('@parameter.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Next argument start',
    },
    {
      ']A',
      function() require('nvim-treesitter-textobjects.move').goto_next_end('@parameter.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Next argument end',
    },
    {
      '[a',
      function() require('nvim-treesitter-textobjects.move').goto_previous_start('@parameter.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Previous argument start',
    },
    {
      '[A',
      function() require('nvim-treesitter-textobjects.move').goto_previous_end('@parameter.outer') end,
      mode = { 'n', 'x', 'o' },
    ...
    {
      ']r',
      function() require('nvim-treesitter-textobjects.move').goto_next_start('@return.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Next return start',
    },
    {
      ']R',
      function() require('nvim-treesitter-textobjects.move').goto_next_end('@return.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Next return end',
    },
    {
      '[r',
      function() require('nvim-treesitter-textobjects.move').goto_previous_start('@return.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Previous return start',
    },
    {
      '[R',
      function() require('nvim-treesitter-textobjects.move').goto_previous_end('@return.outer') end,
      mode = { 'n', 'x', 'o' },
    ...
    {
      ']j',
      function() require('nvim-treesitter-textobjects.move').goto_next_start('@conditional.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Next judge start',
    },
    {
      ']J',
      function() require('nvim-treesitter-textobjects.move').goto_next_end('@conditional.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Next judge end',
    },
    {
      '[j',
      function() require('nvim-treesitter-textobjects.move').goto_previous_start('@conditional.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Previous judge start',
    },
    {
      '[J',
      function() require('nvim-treesitter-textobjects.move').goto_previous_end('@conditional.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Previous judge end',
    },
    {
      ']l',
      function() require('nvim-treesitter-textobjects.move').goto_next_start('@loop.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Next loop start',
    },
    {
      ']L',
      function() require('nvim-treesitter-textobjects.move').goto_next_end('@loop.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Next loop end',
    },
    {
      '[l',
      function() require('nvim-treesitter-textobjects.move').goto_previous_start('@loop.outer') end,
      mode = { 'n', 'x', 'o' },
      desc = 'Previous loop start',
    },
    {
      '[L',
      function() require('nvim-treesitter-textobjects.move').goto_previous_end('@loop.outer') end,
      mode = { 'n', 'x', 'o' },
